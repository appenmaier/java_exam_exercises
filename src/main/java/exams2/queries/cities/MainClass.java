...
public class MainClass {
   ...
   public static void main(String[] args) {
      ...
      queries.cities()
            .add(new City("Stadt A",
                  599,
                  2976243,
                  GeoLocation.EUROPE,
                  new Major("Buergermeister A", Gender.MALE),
                  Arrays.asList("POI 1", "POI 2", "POI 3")));
      queries.cities()
            .add(new City("Stadt B",
                  745,
                  4230822,
                  GeoLocation.AFRICA,
                  new Major("Buergermeister B", Gender.INTERSEX),
                  Arrays.asList("POI 1", "POI 2")));
      queries.cities()
            .add(new City("Stadt C",
                  134,
                  430219,
                  GeoLocation.EUROPE,
                  new Major("Buergermeister C", Gender.FEMALE),
                  Arrays.asList("POI 1")));
      queries.cities()
            .add(new City("Stadt D",
                  657,
                  1198230,
                  GeoLocation.ASIA,
      ...
      queries.cities()
            .add(new City("Stadt E",
                  280,
                  789344,
                  GeoLocation.NORTH_AMERICA,
                  new Major("Buergermeister E", Gender.MALE),
                  Arrays.asList("POI 1", "POI 2", "POI 3")));
      queries.cities()
            .add(new City("Stadt F",
                  912,
                  6982718,
                  GeoLocation.EUROPE,
      ...
      System.out.println();
      queries.getAllNamesFromCitiesInEuropeWithMoreThan1MioInhabitants()
